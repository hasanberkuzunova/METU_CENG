...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    std::vector<Flight *> helpersearchflight(BSTNode<Flight> *temp,std::vector<Flight*> &fly,const std::string &departureCity, const std::string &arrivalCity);
    Flight* helperflightcode(BSTNode<Flight> *temp,const std::string &flightCode);
